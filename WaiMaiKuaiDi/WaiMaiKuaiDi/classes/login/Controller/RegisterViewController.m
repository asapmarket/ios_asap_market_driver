...
- (void)registerButtonClick{
    ...
    if (_yesButton.isSelected) {
        ...
        UIAlertAction *verifyAction = [UIAlertAction actionWithTitle:NSLocalizedString(kPrompt, nil) style:(UIAlertActionStyleDestructive) handler:^(UIAlertAction * _Nonnull action) {
